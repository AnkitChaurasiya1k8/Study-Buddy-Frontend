...
function StudyWithAI() {
  ...
  const handleAsk = async () => {
    ...
    try {
      const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiNjg1ZTg3NjA1YWU0MGRjMDViNGU5YjkwIiwiZXhwIjoxNzUxNzE3Njg5fQ.oRXr77b30wZh6s4rbPBz6uXVKzPKkFD97_r4OiU_uz0";
      ...
      const uploadRes = await axios.post(
        "http://localhost:5000/upload-chat-pdf",
        formData,
        {
          headers: {
      ...
      const chatRes = await axios.post(
        "http://localhost:5000/chat-with-pdf",
        {
          question: question,
          pdf_id: pdfId,
        },
